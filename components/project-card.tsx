      ...
      >
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="p-6 flex-grow">
            ...
            <div className="flex justify-end gap-4 mt-auto pt-4 border-t border-zinc-700/50">
              {/* 智能开关：只有当 repoUrl 存在时，才显示代码按钮 */}
              {repoUrl && (
              ...
              {/* 智能开关：只有当 demoUrl 存在时，才显示浏览按钮 */}
              {demoUrl && (
                <Button
                  size="sm"
                  className="bg-gradient-to-r from-zinc-800 to-zinc-700 hover:from-zinc-700 hover:to-zinc-600 border border-zinc-600/50 text-white"
                  asChild
                >
